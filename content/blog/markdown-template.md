...
authors: ["Yuechen Zhu", "John Doe", "Author 3", "Author 4", "Author 5"]
---
...
This is {{< abbr "html" >}} abbreviation example.

It converts "{{< abbr "html" >}}", but keep intact partial entries like "xxxHTMLyyy" and so on.

The {{< abbr "tcp" >}} is not the
{{< abbr "udp" >}}.
Again,
{{< abbr "tcp" >}} is not
{{< abbr "udp" >}}.
